...
<div class="content-card p-4 mb-4">
    ...
    <form action="{{ route('produk.update', $produk->id_produk) }}" method="POST" class="js-loading-form mt-4">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="kode_produk" class="form-label">Kode Produk</label>
                <input type="text" name="kode_produk" id="kode_produk" class="form-control @error('kode_produk') is-invalid @enderror" value="{{ old('kode_produk', $produk->kode_produk) }}">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" step="0.01" name="harga_satuan" id="harga_satuan" class="form-control @error('harga_satuan') is-invalid @enderror" value="{{ old('harga_satuan', $produk->harga_satuan) }}">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="number" name="stok_terkini" id="stok_terkini" class="form-control @error('stok_terkini') is-invalid @enderror" value="{{ old('stok_terkini', $produk->stok_terkini) }}">
                @error('stok_terkini')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-4 mb-3">
                <label for="stok_minimum" class="form-label">Stok Minimum</label>
                <input type="number" name="stok_minimum" id="stok_minimum" class="form-control @error('stok_minimum') is-invalid @enderror" value="{{ old('stok_minimum', $produk->stok_minimum) }}">
